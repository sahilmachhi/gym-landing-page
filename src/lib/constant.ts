...
export const content = {
    ...
    about: {
        ...
        description: "At ManOfSteel, we empower individuals to achieve their fitness goals with expert trainers, state-of-the-art equipment, and a welcoming community.",
        image: gymImage
    },
    feature: {
        header: "Transform Your Fitness Journey with Our Exceptional Features",
        description: "Discover a world-class gym experience designed to cater to every fitness level. From personalized training sessions to energizing group classes and cutting-edge strength and conditioning programs, we offer everything you need to achieve your goals.",
        CardContent: [
            {
    ...
    plans: {
        ...
        description: "Choose a plan that works best for you. Whether you're just starting your fitness journey or looking to take your workouts to the next level, our membership options offer something for everyone. Enjoy transparent pricing with no hidden fees!",
        membershipPlans: [
            {
    ...
    trainer: {
        ...
        description: "Our team of certified trainers is dedicated to helping you achieve your fitness goals. With diverse specializations, years of experience, and a passion for health and wellness, they are here to guide, motivate, and inspire you every step of the way. Whether you’re a beginner or a seasoned athlete, our trainers provide personalized support to ensure your success.",
        trainers: [
            {
                name: "Alexander",
                specialization: "Strength Training & Weightlifting",
                certifications: [
                    "Certified Strength and Conditioning Specialist (CSCS)", "USA Weightlifting Level 1 Coach",
                ],
                experience: "8+ years",
                ...
                certifications: [
                    "Certified Personal Trainer (CPT) by NASM", "TRX Suspension Training Certified",
                ],
                experience: "5+ years",
                ...
                certifications: [
                    "Registered Yoga Teacher (RYT 200)", "Certified Pilates Instructor",
                ],
                experience: "6+ years",
    ...
    testimonial: {
        ...
        description: "Hear from our members about their incredible fitness journeys, their successes, and why they love being part of our community.",
        testimonials: [
            {
    ...
    contact: {
        ...
        description: "Have questions or need assistance? Reach out using the contact form, email, or phone. You can also visit us—check the map for directions. We’re here to help you start your fitness journey!",
        phone: {
    ...
    faq: {
        ...
        description: "Our gym is open Monday to Friday from 5:00 AM to 10:00 PM and on weekends from 6:00 AM to 8:00 PM.",
        faqs: [
            {
    ...
    cta: {
        ...
        description: "Ready to transform your fitness journey? Sign up today and unlock access to our world-class facilities, expert trainers, and engaging group classes. Whether you're a beginner or a fitness enthusiast, we have everything you need to reach your goals. Don't wait—start now!",
