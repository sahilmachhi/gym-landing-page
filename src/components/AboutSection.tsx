            ...
            <section className='mx-auto text-center container px-10' >
                <div className='grid md:grid-cols-2 grid-cols-1 gap-5'>
                 ...
                 {about.header}
                        ...
                        <p className='text-lg text-white/70 max-w-[420px] lg:text-left text-center'>{about.description}</p>
                    </div>
                    <div>
                      <Image src={about.image} alt="gym Image" className='rounded-xl object-contain' />
                    </div>
                </div>
            </section>
        </div>
