        ...
        <div className='pt-[140px] relative' id="cta">
            ...
            <section className="bg-gradient-to-br from-gray-800 via-black/60 to-gray-700 py-16 px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto text-center">
                    <h2 className='text-center text-3xl font-bold  tracking-tight text-white md:text-5xl max-w-4xl'>{cta.header}</h2>
                    <p className='text-center text-2xl mt-6 text-white/70 max-w-5xl'>{cta.description}</p>
                    ...
                    <p className="mt-4 text-sm text-gray-400">{cta.leftctabtn}</p>
                </div>
            </section>
        </div>
    )
